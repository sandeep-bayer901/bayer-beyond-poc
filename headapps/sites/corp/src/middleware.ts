...
// Catalyst themes
import themes from '.sitecore/themes.json';
import { ThemeMiddleware } from '@catalyst/feature-themes';
...
//Catalyst themes
const theme = new ThemeMiddleware({
  sites,
  ...scConfig.api.edge,
  ...scConfig.multisite,
  themes,
...
export function middleware(req: NextRequest, ev: NextFetchEvent) {
  return defineMiddleware(multisite, theme, redirects, personalize).exec(req, ev);
}
